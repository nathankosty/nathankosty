...
### 🥏 [Purple Reign Stats](https://github.com/nathankosty/purple-reign-stats) · [live](https://purple-reign-stats.vercel.app)

Box-score stats misrepresent ultimate frisbee, so I built a per-point player valuation model for my team's season and shipped it as a web app. Every weight in the model is an argument about the sport, and the README defends each one.
